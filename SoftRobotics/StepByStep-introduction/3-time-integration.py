def createScene(rootNode):
	...
	# Adding a linear solver to solve the numerical system: here the direct solver using the LDLt decomposition
	particleNode.addObject("SparseLDLSolver", name="linear_solver")
