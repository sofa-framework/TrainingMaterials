...
def createScene(rootNode):
	...
	CFF = mechanicalModel.addObject("ConstantForceField", name="force_tip_node", totalForce=[0, 0, 0], indices=mechanicalModel.select_nodes_pulled_down.indices.linkpath, showArrowSize=0.3) # Project constraint enforcing fixed DoFs

	mechanicalModel.addObject("Visual3DText", name="visualizeData", text=CFF.totalForce.linkpath, position=[0, -10, 0], color="green", scale="20", depthTest="false")
