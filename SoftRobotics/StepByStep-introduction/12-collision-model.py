def createScene(rootNode):
	...
	# collisionlModel.addObject("LineCollisionModel", name="line_collision_model", contactStiffness=3, selfCollision=True) # For self collision, Line and/or Point primitives should be added
	...
	# fallingParticle.addObject("UniformMass", name="nodal_mass", totalMass=0.01)
	# fallingParticle.addObject("ConstantForceField", name="nodal_force", totalForce=[0,90,0,0,0,0], indices=0)
	# fallingParticle.addObject("SphereCollisionModel", name="sphere_collision_model", radius=10, contactStiffness=50)
	##########################################
